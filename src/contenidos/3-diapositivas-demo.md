---
layout: page
title: Catálogo de Variaciones de Diapositivas
description: Guía de referencia con todos los patrones de diseño disponibles en EduPress
---
...
```mermaid
sequenceDiagram
    participant A as Paso 1
    participant B as Paso 2
    participant C as Resultado
    A->>B: Transición
    B->>C: Entrega
    C-->>A: Feedback
```
